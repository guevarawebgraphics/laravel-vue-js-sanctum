                ...
                <div class="mt-12">
                    <div v-cloak>
                        <div class="mt-8">
                            ...
                            <input v-model="name" @keyup.enter="register"
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                type="text" placeholder="e.g Richard Guevara" autocomplete="name">
                        </div>

                         <div class="mt-8">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email Address</div>
                            <input v-model="email" @keyup.enter="register"
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                type="email" placeholder="e.g info@guevarawebgraphics.com" autocomplete="email">
                        </div>
                         ...
                         <div class="mt-8">
                                ...
                                <input v-model="password" @keyup.enter="register"
                                    class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                    type="password" placeholder="Enter your password" autocomplete="new-password">
                            </div>
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                            ...
                            <input v-model="password_confirmation" @keyup.enter="register"
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                type="password" placeholder="Confirm your password" autocomplete="new-password">
                        </div>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                       Already have an account ? <a href="/login" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign
                            in</a>
                    </div>
                </div>
            </div>

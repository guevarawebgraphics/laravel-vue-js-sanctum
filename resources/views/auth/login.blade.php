                ...
                <div class="mt-12">
                    ...
                    <div v-cloak>
                        <div>
                            ...
                            <input 
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500  @error('username') text-red-500 @enderror" 
                                value="" 
                                type="text" 
                        ...
                        <div class="mt-8">
                            ...
                            <input 
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500  @error('password') text-red-500 @enderror" 
                                type="password" 
                                name="password" 
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <a href="{{url('register')}}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
